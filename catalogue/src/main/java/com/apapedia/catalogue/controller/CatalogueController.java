...
public class CatalogueController {
    ...
    @GetMapping(value = "/catalogue", params = { "minPrice", "maxPrice" })
    public ResponseEntity<List<Catalogue>> getAllCatalogueByPriceRange(@RequestParam("minPrice") int minPrice,
            @RequestParam("maxPrice") int maxPrice) {
        List<Catalogue> catalogues = catalogueService.getAllCatalogueByPrice(minPrice, maxPrice);
